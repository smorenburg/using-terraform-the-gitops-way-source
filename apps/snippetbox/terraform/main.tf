...
locals {
  ...
  suffix = "${var.app_abbreviation}-${local.location_abbreviation}"
...
resource "azurerm_key_vault_secret" "mysql_login" {
  ...
  key_vault_id = data.terraform_remote_state.default.outputs.azurerm_key_vault_default_id
}
...
resource "azurerm_mysql_flexible_server" "default" {
  name                   = "mysql-${var.app_abbreviation}-${random_id.mysql.hex}"
